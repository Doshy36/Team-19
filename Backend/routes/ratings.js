...
router.post('/ratings/set', passport.authenticate('jwt', {session: false}), function(req, res, next){
    var sql = "INSERT INTO UserRating (userId, placeId, rating) VALUES (?, ?, ?) ON DUPLICATE KEY UPDATE rating=?";
    var par = [req.user, req.body.placeId, req.body.rating, req.body.rating];
